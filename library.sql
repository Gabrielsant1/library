...
-- -----------------------------------------------------
-- Schema epiz_28916585_library
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema epiz_28916585_library
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `epiz_28916585_library` DEFAULT CHARACTER SET utf8 ;
USE `epiz_28916585_library` ;

-- -----------------------------------------------------
-- Table `epiz_28916585_library`.`TIPO_USUARIO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `epiz_28916585_library`.`TIPO_USUARIO` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `epiz_28916585_library`.`EIXO` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `epiz_28916585_library`.`CURSO` (
  ...
  CONSTRAINT `fk_CURSO_EIXO1`
    ...
    REFERENCES `epiz_28916585_library`.`EIXO` (`IDEIXO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);


-- -----------------------------------------------------
-- Table `epiz_28916585_library`.`USUARIO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `epiz_28916585_library`.`USUARIO` (
  ...
  CONSTRAINT `fk_ALUNO_TIPO_USUARIO`
    ...
    REFERENCES `epiz_28916585_library`.`TIPO_USUARIO` (`IDTIPO_USUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_USUARIO_CURSO1`
    FOREIGN KEY (`CURSO_IDCURSO`)
    REFERENCES `epiz_28916585_library`.`CURSO` (`IDCURSO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);


-- -----------------------------------------------------
-- Table `epiz_28916585_library`.`TRABALHO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `epiz_28916585_library`.`TRABALHO` (
...
-- -----------------------------------------------------
-- Table `epiz_28916585_library`.`AUTOR`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `epiz_28916585_library`.`AUTOR` (
  ...
  CONSTRAINT `fk_USUARIO_has_TRABALHO_USUARIO1`
    ...
    REFERENCES `epiz_28916585_library`.`USUARIO` (`IDUSUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_USUARIO_has_TRABALHO_TRABALHO1`
    FOREIGN KEY (`TRABALHO_IDTRABALHO`)
    REFERENCES `epiz_28916585_library`.`TRABALHO` (`IDTRABALHO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);


-- -----------------------------------------------------
-- Table `epiz_28916585_library`.`HISTORICO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `epiz_28916585_library`.`HISTORICO` (
